<html>
    <head>
        ...
        if (!class_exists('lessc')) {
            include ('../modul-10/libs/lessc.inc.php');
        }
        $less = new lessc;
        $less->compileFile('less/modul-10-less.less', 'css/modul-10-css.css');
        ?>
        <link href="css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        <link href="css/modul-10-css.css" rel="stylesheet" type="text/css"/>
