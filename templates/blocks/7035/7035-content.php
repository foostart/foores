...
?>
                ...
                <div class="form">
                    <form class="form-content">
                        ...
                        <div class="inline-group row">
                            <div class="field required col-sm-4">
                                ...
                                <div class="nf-field-element">
                                    <input id="nf-field-37" name="nf-field-37" aria-invalid="true" aria-describedby="nf-error-37" class="ninja-forms-field nf-element" type="text" value="">
                                </div>
                            ...
                            <div class="field required col-sm-4">
                                ...
                                <div class="nf-field-element">
                                    <input id="nf-field-38" name="nf-field-38" aria-invalid="true" aria-describedby="nf-error-38" class="ninja-forms-field nf-element" type="email" value="">
                            ...
                            <div class="field col-sm-4">
                                ...
                                <div class="nf-field-element">
                                    <input id="nf-field-39" name="nf-field-39" aria-invalid="false" aria-describedby="nf-error-39" class="ninja-forms-field nf-element" type="tel" value="" >
                                </div>
                        ...
                        <div class="field required">
                            ...
                            <div class="nf-field-element">
                                <textarea id="nf-field-40" name="nf-field-40" aria-invalid="true" aria-describedby="nf-error-40" class="ninja-forms-field nf-element" "=" "></textarea>
</div>
               <div class="nf-after-field "><nf-section>

    <div class="nf-input-limit "></div>

    <div id="nf-error-40 " class="nf-error-wrap nf-error " role="alert "><div class="nf-error-msg nf-error-required-error "><div class="hide">This is a required field.</div></div></div>
    ...
    <div id="nf-form-errors-1 " class="nf-form-errors " role="alert "><nf-errors><nf-section>
